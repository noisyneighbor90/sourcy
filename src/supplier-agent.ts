...
// Sample offers — matched to Nexon Electronics PCB assembly profile
const offers: ProcurementOffer[] = [
  {
    ...
    notes: "EU-based PCB assembly specialist, Vilnius Lithuania, ISO certified since 2015.",
  },
  {
    type: "procurement_offer",
    offerId: randomUUID().slice(0, 8),
    ...
    notes: "High volume Chinese manufacturer, missing IPC-A-610 certification.",
  },
  {
    type: "procurement_offer",
    offerId: randomUUID().slice(0, 8),
    ...
    notes: "Polish manufacturer, Gdansk, competitive lead times.",
  },
];
